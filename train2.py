...
if __name__ == '__main__':
    ...
    # --- Generate weights out of the class distribution as a torch tensor --- #
    _weights = class_weights / np.sum(class_weights) # normalized class weights
    _weights = torch.tensor(_weights, dtype=torch.float32).to(device)
