    ...
    <div className="flex items-center justify-center min-h-screen px-4">
      <div className="w-full max-w-md">
        <form onSubmit={handleSubmit} className="bg-gray-900/70 backdrop-blur p-8 md:p-10 rounded-2xl shadow-2xl border border-gray-800">
          <h2 className="text-4xl font-extrabold mb-8 text-center text-white">Create an Account</h2>
          ...
          <p className="text-center mt-6 text-gray-400">
            Already have an account? <Link to="/login" className="text-teal-400 hover:underline font-medium">Login here</Link>
          </p>
        </form>
      </div>
    </div>
